...
// Event Hub private endpoint (conditional on VNet being enabled)
module eventHubPrivateEndpoint './app/eventhub-PrivateEndpoint.bicep' = if (vnetEnabled) {
  name: 'eventHubPrivateEndpoint'
  scope: rg
  params: {
    location: location
    tags: tags
