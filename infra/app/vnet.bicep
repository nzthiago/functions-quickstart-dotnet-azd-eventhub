...
@description('Specifies the name of the subnet for the EventHub private endpoint.')
param eventHubSubnetName string = 'eventhub-private-endpoints-subnet'
...
output eventHubSubnetName string = eventHubSubnetName
output eventHubSubnetID string = '${virtualNetwork.outputs.resourceId}/subnets/${eventHubSubnetName}'
